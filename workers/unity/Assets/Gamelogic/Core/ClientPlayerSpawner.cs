...
namespace Assets.Gamelogic.Core
{
    ...
    public static class ClientPlayerSpawner
    {
        ...
        public static EntityId PlayerEntityId = EntityId.InvalidEntityId;
        ...
        {
            if (EntityId.IsValidEntityId(SimulationManagerEntityId) && EntityId.IsValidEntityId(PlayerEntityId))
            {
        ...
        private static void FindSimulationManagerEntityId(Action<EntityId> callback)
        {
            ...
            {
                Constraint = new ComponentConstraint(PlayerLifeCycle.ComponentId),
        ...
        private static void OnSpawnPlayerResponse(EntityId simulationManagerEntityId, ICommandCallbackResponse<SpawnPlayerResponse> response)
        {
            ...
            PlayerEntityId = response.Response.Value.playerEntityId;
        }
    }
}
