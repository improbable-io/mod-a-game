...
namespace Assets.Gamelogic.Player
{
    public class PlayerInputListener : MonoBehaviour
    {
        ...
        private PlayerControlsSender playerControlsSender;
        private SpellsRequester spellsBehaviour;
        private Vector3 inputDirection = Vector3.zero;

        private void Awake()
        {
            playerControlsSender = GetComponent<PlayerControlsSender>();
            spellsBehaviour = GetComponent<SpellsRequester>();
        }
